<div class="content"><h1>Sf guard users List</h1>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $sf_guard_user->getType() ?></td>
      <td><?php echo $sf_guard_user->getRut() ?></td>
      <td><?php echo $sf_guard_user->getAddress() ?></td>
      <td><?php echo $sf_guard_user->getMobile() ?></td>
      <td><?php echo $sf_guard_user->getPhone() ?></td>
